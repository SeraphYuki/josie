...
"uniform mat4 proj;\n"
"void main(){\n"
    "gl_Position = proj * vec4(pos * 3,-3,1);\n"
    "Color = color;"
...
"varying vec2 TexCoord;\n"
"void main(){\n"
    "Position_CamSpace = (proj * view * model * vec4(pos, 1)).xyz;\n"
...
"void main(){\n"
    ...
    "gl_Position = proj * vec4(Position_CamSpace, 1);\n"
...
static const char *skeletalVSource = 
"#version 120\n"
STR(
attribute vec3 pos;
attribute vec2 coord;
...
static const char *particleVSource = 
"#version 120\n"
STR(
...
unsigned int Shaders_GetSpecularLocation(){
    return shaders[activeProgram].specularLoc;
}
unsigned int Shaders_GetDiffuseLocation(){
    return shaders[activeProgram].diffuseLoc;
}
