...
char Math_Vec2EqualToVec2(Vec2 v1, Vec2 v2){ return (char)(v1.x == v2.x && v1.y == v2.y); }
Vec2 Math_Vec2MultFloat(Vec2 v1, float s){ return (Vec2){v1.x * s, v1.y * s}; }
Vec2 Math_Vec2MultVec2(Vec2 v1, Vec2 v2){ return (Vec2){v1.x * v2.x, v1.y * v2.y}; }
Vec2 Math_Vec2DivideFloat(Vec2 v1, float s){ return (Vec2){v1.x / s, v1.y / s}; }
Vec2 Math_Vec2DivideVec2(Vec2 v1, Vec2 v2){ return (Vec2){v1.x / v2.x, v1.y / v2.y}; }
Vec2 Math_Vec2AddFloat(Vec2 v1, float s){ return (Vec2){v1.x + s, v1.y + s}; }
Vec2 Math_Vec2AddVec2(Vec2 v1, Vec2 v2){ return (Vec2){v1.x + v2.x, v1.y + v2.y}; }
Vec2 Math_Vec2SubFloat(Vec2 v1, float s){ return (Vec2){v1.x - s, v1.y - s}; }
Vec2 Math_Vec2SubVec2(Vec2 v1, Vec2 v2){ return (Vec2){v1.x - v2.x, v1.y - v2.y}; }
float Math_Vec2Magnitude(Vec2 v) { return sqrt(v.x*v.x + v.y*v.y); }
float Math_Vec2Dot(Vec2 v1, Vec2 v2){ return (v1.x * v2.x) + (v1.y * v2.y); }
Vec2 Math_RoundVec2(Vec2 v){ return (Vec2){roundf(v.x), roundf(v.y)}; }
...
char Math_Vec3EqualToVec3(Vec3 v1, Vec3 v2){ return (char)(v1.x == v2.x && v1.y == v2.y && v1.z == v2.z); }
Vec3 Math_Vec3MultFloat(Vec3 v1, float s){ return (Vec3){v1.x * s, v1.y * s, v1.z * s}; }
Vec3 Math_Vec3MultVec3(Vec3 v1, Vec3 v2){ return (Vec3){v1.x * v2.x, v1.y * v2.y, v1.z * v2.z}; }
Vec3 Math_Vec3DivideFloat(Vec3 v1, float s){ return (Vec3){v1.x / s, v1.y / s, v1.z / s}; }
Vec3 Math_Vec3DivideVec3(Vec3 v1, Vec3 v2){ return (Vec3){v1.x / v2.x, v1.y / v2.y, v1.z / v2.z}; }
Vec3 Math_Vec3AddFloat(Vec3 v1, float s){ return (Vec3){v1.x + s, v1.y + s, v1.z + s}; }
Vec3 Math_Vec3AddVec3(Vec3 v1, Vec3 v2){ return (Vec3){v1.x + v2.x, v1.y + v2.y, v1.z + v2.z}; }
Vec3 Math_Vec3SubFloat(Vec3 v1, float s){ return (Vec3){v1.x - s, v1.y - s, v1.z - s}; }
...
Vec2 Math_Vec3ToVec2(Vec3 v){ return (Vec2){v.x, v.y }; }
Vec3 Math_Vec2ToVec3(Vec2 v){ return (Vec3){v.x, v.y, 0}; }
Vec3 Math_RoundVec3(Vec3 v){ return (Vec3){roundf(v.x), roundf(v.y), roundf(v.z)}; }
...
Vec3 Math_Vec4ToVec3(Vec4 v){ return (Vec3){v.x, v.y, v.z}; }
Vec2 Math_Vec4ToVec2(Vec4 v){ return (Vec2){v.x, v.y }; }
char Math_Vec3EqualToVec4(Vec4 v1, Vec4 v2){ return (char)(v1.x == v2.x && v1.y == v2.y && v1.z == v2.z && v1.w == v2.w); }
Vec4 Math_Vec4MultFloat(Vec4 v1, float s){ return (Vec4){v1.x * s, v1.y * s, v1.z * s, v1.w * s}; }
Vec4 Math_Vec4MultVec4(Vec4 v1, Vec4 v2){ return (Vec4){v1.x * v2.x, v1.y * v2.y, v1.z * v2.z, v1.w * v2.w}; }
Vec4 Math_Vec4DivideFloat(Vec4 v1, float s){ return (Vec4){v1.x / s, v1.y / s, v1.z / s, v1.w / s}; }
Vec4 Math_Vec4DivideVec4(Vec4 v1, Vec4 v2){ return (Vec4){v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w}; }
Vec4 Math_Vec4AddFloat(Vec4 v1, float s){ return (Vec4){v1.x + s, v1.y + s, v1.z + s, v1.w + s}; }
Vec4 Math_Vec4AddVec4(Vec4 v1, Vec4 v2){ return (Vec4){v1.x + v2.x, v1.y + v2.y, v1.z + v2.z, v1.w + v2.w}; }
Vec4 Math_Vec4SubFloat(Vec4 v1, float s){ return (Vec4){v1.x - s, v1.y - s, v1.z - s, v1.w - s}; }
Vec4 Math_Vec4SubVec4(Vec4 v1, Vec4 v2){ return (Vec4){v1.x - v2.x, v1.y - v2.y, v1.z - v2.z, v1.w - v2.w}; }
float Math_Vec4Magnitude(Vec4 v) { return sqrt(v.x*v.x + v.y*v.y + v.z* v.z + v.w*v.w); }
Vec4 Math_RoundVec4(Vec4 v){ return (Vec4){roundf(v.x), roundf(v.y), roundf(v.z), roundf(v.w)}; }
...
Rect Math_Rect(Vec3 pos, float width, float height){ return (Rect){pos.x, pos.y, pos.z, width, height}; }
Vec3 Math_RectXYZ(Rect r){ return (Vec3){r.x, r.y, r.z};  }
Rect2D Math_RoundRect2D(Rect2D r){ return (Rect2D){roundf(r.x), roundf(r.y), roundf(r.w), roundf(r.h) }; }
Rect Math_RoundRect(Rect r){ return (Rect){roundf(r.x), roundf(r.y), roundf(r.z), roundf(r.w), roundf(r.h) }; }
...
Cube Math_Cube(Vec3 pos, float width, float height, float depth){ return (Cube){pos.x, pos.y, pos.z, width, height, depth}; }
Vec3 Math_CubeXYZ(Cube r){ return (Vec3){r.x, r.y, r.z};  }
...
float Math_DistanceToPlane(Plane p, Vec3 point) { return p.a*point.x + p.b*point.y + p.c*point.z + p.d; }
